...
@InputType()
class WarehouseCreateNestedManyWithoutProductsInput {
...
export { WarehouseCreateNestedManyWithoutProductsInput as WarehouseCreateNestedManyWithoutProductsInput };
